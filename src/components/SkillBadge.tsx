...
export function SkillBadge({ skill, index = 0 }: { skill: string; index?: number }) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}
      className="px-6 py-3 text-base font-medium transition-all border border-white/10 rounded-full bg-white/[0.03] backdrop-blur-md hover:border-purple-500/50 hover:shadow-[0_0_20px_rgba(168,85,247,0.15)] cursor-default relative overflow-hidden group"
    >
      {/* Shimmer on hover */}
